...
def create_ffn_model(model_class_name, params):
    from quarc.models.ffn_models import (
        AgentFFNWithReactionClass, TemperatureFFN,
        ReactantAmountFFN, AgentAmountFFN
    )
    from quarc.models.modules.ffn_heads import (
        FFNAgentHeadWithReactionClass, FFNTemperatureHead,
        FFNReactantAmountHead, FFNAgentAmountHead
    )
...
def create_gnn_model(model_class_name, params):
    from quarc.models.gnn_models import (
        AgentGNNWithReactionClass, TemperatureGNN,
        ReactantAmountGNN, AgentAmountOneshotGNN
    )
    from quarc.models.modules.gnn_heads import (
        GNNAgentHeadWithReactionClass, GNNTemperatureHead,
        GNNReactantAmountHead, GNNAgentAmountHead
    )
